class Api::V1::HcCvsController < ApplicationController
  def create
    if current_api_v1_user
      ...
      if is_possible_cheervote["is_login_user_possible_to_cv_on_term"] &&
        is_possible_cheervote["hc_member"]["id"] == params[:member_id] &&
        is_possible_cheervote["current_cv_term"]["id"] == params[:cv_term_id]

        cheervote_create_data = HcCv.new(
          hc_member_id: is_possible_cheervote["hc_member"]["id"],
          user_id: current_api_v1_user.id,
          hc_cv_term_id: is_possible_cheervote["current_cv_term"]["id"],
